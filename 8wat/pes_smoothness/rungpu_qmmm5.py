''' run QM/MM-Multipole for an array of MM water positions
...
mol = gto.Mole(output="rungpu_qmmm5_{:.2f}.pyscflog".format(rcut_hcore))
mol.charge = charge
mol.spin = spin
mol.verbose = 3
...
fname = "rungpu_qmmm5_{:.2f}_results.npz".format(rcut_hcore)
